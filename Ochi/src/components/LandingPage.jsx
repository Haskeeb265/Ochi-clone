    ...
    <div className='w-full h-screen bg-white-100 pt-1'>
        <div className='textstructure mt-52 px-20'>
                ...
                return(
                    <div className='masker'>
                        <div className='w-fit flex items-end'>
                            ...
                            <h1 className='pt-[1vw] -mb-[-0.3vw] text-black uppercase text-[10vw] font-semibold leading-[6vw] font-["Founders_Grotesk_X"]'>{item}</h1>
                        </div>
                    </div>
                )
            })}
            <div className='border-t-[1px] border-zinc-800 mt-56 flex justify-between item-center py-5 px-10 '>
                ...
                (<p className=' font-["Neue_Montreal"] text-md text-black tracking-tight leadning-none'>{item}</p>))}
            <div className='start flex items-center gap-5'>
                <div className=' font-["Neue_Montreal"] px-5 py-2 border-[1px] border-zinc-700 text-sm  rounded-full text-black'>START THE PROJECT</div>
